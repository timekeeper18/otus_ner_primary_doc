...
_CITATION = """LegalDoc.AI"""

_DESCRIPTION = """LD dataset for NER tasks for primary documents, like invoice, utd..."""
...
class Wikiann(datasets.GeneratorBasedBuilder):
    ...
    BUILDER_CONFIGS = [
        WikiannConfig(name=lang, description=f"LD NER examples in language {lang}") for lang in _LANGS
    ]
    ...
    def _split_generators(self, dl_manager):
        ...
        wikiann_dl_dir = str(BASE_DIR.joinpath("data/interim"))
        wikiann_dl_dir = '/content/bert_ner_data'
        lang = self.config.name
        lang_folder = dl_manager.extract(os.path.join(wikiann_dl_dir, lang + ".tar.xz"))
